...
import { fetchDebate } from '../store/debate-actions'
// import { debateActions } from "../store/debate-slice";
...
const DebateMain = () => {
    ...
    const isFinishedDebates = useSelector(state => state.debate.isFinishedDebates)
